...
CatCare uses a three-layer architecture designed around a core principle: **if the answer is a lookup, use structured storage; if it requires reasoning, use RAG.**
